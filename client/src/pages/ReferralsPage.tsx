      ...
      <div className="bg-indigo-50/50 border border-indigo-100 rounded-xl p-4 mb-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-4 gap-3">
          <div className="flex items-start gap-2">
            ...
            <p className="text-xs text-indigo-800">Create a referral with the specialist name, reason, and urgency level</p>
          </div>
          <div className="flex items-start gap-2">
            ...
            <p className="text-xs text-indigo-800">Send the referral letter to the specialist electronically</p>
          </div>
          <div className="flex items-start gap-2">
            ...
            <p className="text-xs text-indigo-800">Track the appointment date and whether the patient followed through</p>
          </div>
          <div className="flex items-start gap-2">
            ...
            <p className="text-xs text-indigo-800">Receive the specialist's report and close the referral loop</p>
          </div>
        </div>
      </div>
