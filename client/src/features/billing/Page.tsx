      ...
      <div className="bg-indigo-50/50 border border-indigo-100 rounded-xl p-4 mb-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-4 gap-3">
          <div className="flex items-start gap-2">
            ...
            <p className="text-xs text-indigo-800">Review all outstanding patient balances sorted by age and severity</p>
          </div>
          <div className="flex items-start gap-2">
            ...
            <p className="text-xs text-indigo-800">Send statements or payment reminders with one click</p>
          </div>
          <div className="flex items-start gap-2">
            ...
            <p className="text-xs text-indigo-800">Track collection status — 30, 60, and 90+ days overdue at a glance</p>
          </div>
          <div className="flex items-start gap-2">
            ...
            <p className="text-xs text-indigo-800">Mark balances as paid once payment is received</p>
          </div>
        </div>
      </div>
