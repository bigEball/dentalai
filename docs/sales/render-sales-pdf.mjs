...
const inputPath = path.resolve(root, process.argv[2] || 'docs/sales/SUMMIT_AI_SALES_GUIDE.md');
const outputPath = path.resolve(root, process.argv[3] || 'docs/sales/Summit-AI-Services-Sales-Playbook.pdf');
